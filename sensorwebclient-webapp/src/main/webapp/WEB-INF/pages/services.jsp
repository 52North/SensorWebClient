...
<body>
	...
	<c:if test="${not empty serviceInstance}">
		<table>
			...
			<tr>
				<td colspan="2"><a
					href="${url}services/${serviceInstance.itemName}/offerings">offerings</a></td>
			</tr>
			<tr>
				<td colspan="2"><a
					href="${url}services/${serviceInstance.itemName}/features">features</a></td>
			</tr>
			<tr>
				<td colspan="2"><a
					href="${url}services/${serviceInstance.itemName}/procedures">procedures</a></td>
			</tr>
			<tr>
				<td colspan="2"><a
					href="${url}services/${serviceInstance.itemName}/phenomenons">phenomenons</a></td>
			</tr>
			<tr>
				<td colspan="2"><a
					href="${url}services/${serviceInstance.itemName}/stations">stations</a></td>
			</tr>
		</table>
