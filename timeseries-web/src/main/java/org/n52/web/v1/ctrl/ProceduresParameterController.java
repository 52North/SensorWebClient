...
public class ProceduresParameterController extends ParameterController {
    ...
    private ProceduresParameterService procedureParameterService;
    ...
    public ModelAndView getCollection(@RequestParam(defaultValue = KVP_DEFAULT_OFFSET) int offset,
        ...
        ProcedureOutput[] allProcedures = procedureParameterService.getProcedures(offset, size);
    ...
    public ModelAndView getItem(@PathVariable("item") String item) {
        ...
        ProcedureOutput procedure = procedureParameterService.getProcedure(item);
    ...
    public ProceduresParameterService getProcedureParameterService() {
        return procedureParameterService;
    }

    public void setProcedureParameterService(ProceduresParameterService procedureParameterService) {
