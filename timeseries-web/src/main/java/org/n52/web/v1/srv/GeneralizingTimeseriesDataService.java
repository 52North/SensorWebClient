...
public class GeneralizingTimeseriesDataService implements TimeseriesDataService {
    ...
    public TimeseriesDataCollection getTimeseriesData(UndesignedParameterSet parameters) {
        ...
        try {
            ...
            TimeseriesDataCollection generalizedData = generalizer.generalize();
    ...
    private void logGeneralizationAmount(TimeseriesDataCollection ungeneralizedData,
                                                     TimeseriesDataCollection generalizedData) {
