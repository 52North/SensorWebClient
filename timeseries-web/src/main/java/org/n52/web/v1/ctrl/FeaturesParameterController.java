...
public class FeaturesParameterController extends ParameterController {
    ...
    private FeaturesParameterService featureParameterService;
    ...
    public ModelAndView getCollection(@RequestParam(defaultValue = KVP_DEFAULT_OFFSET) int offset,
        ...
        FeatureOutput[] allFeatures = featureParameterService.getFeatures(offset, size);
    ...
    public ModelAndView getItem(@PathVariable("item") String item) {
        ...
        FeatureOutput feature = featureParameterService.getFeature(item);
    ...
    public FeaturesParameterService getFeatureParameterService() {
        return featureParameterService;
    }

    public void setFeatureParameterService(FeaturesParameterService featureParameterService) {
