...
public class SwitchGridEvent extends FilteredDispatchGwtEvent<SwitchGridEventHandler> {
    ...
    public static Type<SwitchGridEventHandler> TYPE = new Type<SwitchGridEventHandler>();
    
    /* (non-Javadoc)
     * @see org.eesgmbh.gimv.client.event.FilteredDispatchGwtEvent#onDispatch(com.google.gwt.event.shared.EventHandler)
     */
    @Override
    protected void onDispatch(SwitchGridEventHandler handler) {
        handler.onSwitch();
    }
     ...
     */
    @Override
    public com.google.gwt.event.shared.GwtEvent.Type<SwitchGridEventHandler> getAssociatedType() {
        return TYPE;
    }
