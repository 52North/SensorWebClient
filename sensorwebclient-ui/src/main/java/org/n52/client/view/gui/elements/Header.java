...
public class Header extends HLayout {
	...
	private Label getCopyrightLink() {
        ...
        Label copyright = getHeaderLinkLabel("&copy; 52&#176;North, " + jahr);
...
//                ClientUtils.destroyAllSingletons();
    ...
    String getPermaLink() {
        ...
        permalink += "&begin="
                + DateTimeFormat.getFormat("yyyy-MM-dd'T'HH:mm:ss").format(new Date(TimeManager.getInst().getBegin()));
        permalink += "&end="
