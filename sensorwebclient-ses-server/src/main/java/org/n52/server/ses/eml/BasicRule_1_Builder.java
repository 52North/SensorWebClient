...
public class BasicRule_1_Builder {
    ...
    public static BasicRule create_BR_1(Rule rule) throws Exception {
        ...
        URL url = new URL(Config.resLocation_1);
        ...
        for (int i = 0; i < simplePatternList.getLength(); i++) {
            ...
            if (i == 1) {
                ...
                userParameterValueNode.setTextContent(rule.getCount());
            }
        }
    ...
    public static Rule getRuleByEML(String eml) {
        ...
        try {
            ...
            } else if (property.equals("fest:PropertyIsNotEqualTo")) {
            ...
            // set rule type
            rule.setRuleType(SimpleRuleType.TENDENZ_ANZAHL);
