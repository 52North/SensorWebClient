...
public class SOSAdapter_OXFExtension extends SOSAdapter {
    ...
    public SOSAdapter_OXFExtension(String sosVersion) {
        super(sosVersion, new ProxyAwareHttpClient(new SimpleHttpClient(5000, SOCKET_TIMEOUT)));
    ...
    public SOSAdapter_OXFExtension(String sosVersion, ISOSRequestBuilder requestBuilder) {
        ...
        log.debug("SOSAdapter_OXFExtension");
        setHttpClient(new ProxyAwareHttpClient(new SimpleHttpClient(5000, SOCKET_TIMEOUT)));
    }
