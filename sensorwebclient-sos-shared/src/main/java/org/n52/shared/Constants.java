...
public abstract class Constants {
     ...
     */
    public static final BoundingBox FALLBACK_EXTENT = new BoundingBox(new EastingNorthing(-90, -45, DISPLAY_PROJECTION), 
                                                                      new EastingNorthing(90, 45, DISPLAY_PROJECTION));
